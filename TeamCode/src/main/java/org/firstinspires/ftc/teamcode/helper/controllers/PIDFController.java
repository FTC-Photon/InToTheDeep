 ...
 * for your robot. It performs calculations to accurately follow a path through a feedback loop
 * (there is a good image at: https://en.wikipedia.org/wiki/Feedback).
 * <p>
 *    A sample usage would be set setPoint then start moving towards it and as you are moving you
 *    accumulate error stored in minIntegral and maxIntegral. Then you will use e(t) the error function
 *    to find how far off you are from setPoint. Last you
 * <p>
 ...
 *
 *<p>
 *     Note: the kF is for fighting friction and gravity
 *<p>
 * This class can be extended by:
 * <p>
 * - {@link PIDController}: Implements a PID controller with proportional, integral, and derivative control (no feedforward).
 * <p>
 * - {@link PDController}: Implements a PD controller with only proportional and derivative control.
 * <p>
 * - {@link PController}: Implements a simple P controller with only proportional control.
 * <p>
 *
 * Feedforward control allows this controller to preemptively compensate for external forces or friction.
 */
public class PIDFController {
    ...
    /**
     * This is the full constructor for the PIDF controller. The PIDF controller
     * includes a feed-forward F which is useful for fighting friction and gravity.
